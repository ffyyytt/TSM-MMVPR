...
def return_mmvpr(modality):
    ...
    if modality == 'RGB':
        root_data = 'data/train/rgb_data'
        filename_imglist_train = 'data/train/train_videofolder.txt'
        filename_imglist_val = 'data/train/val_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'mmvpr': return_mmvpr }
