...
parser.add_argument('--arch', type=str, default="resnext101_64x4d")
...
parser.add_argument('--test_file', type=str, default='test_videofolder.txt')
...
video_pred = [" ".join(list(map(str, torch.topk(x[0][0], k=5).indices.cpu().numpy().tolist()))) for x in output]
